...
public class JsonUtils {
  ...
  public static <T> T parseJson(
      String jsonString, final Class<?> rawClass, final Class<?> parameter) {
  ...
  public static <T> JsonDeserializer<T> getSerializer(
      final Class<T> rawClass, final Class<?> parameter) {
