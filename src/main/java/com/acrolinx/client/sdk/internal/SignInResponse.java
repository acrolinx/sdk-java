...
public abstract class SignInResponse
{
    ...
    static final TypeSelector<SignInResponse> TYPE_SELECTOR = jsonElement -> {
        boolean isSuccess = jsonElement.getAsJsonObject().get("data").getAsJsonObject().has("accessToken");
